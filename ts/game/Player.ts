...
class Player {
	...
	update() {
		...
		if (this.movement.UP) this.pos.subtract(0, speed);
		if (this.movement.RIGHT) this.pos.add(speed, 0);
		if (this.movement.DOWN) this.pos.add(0, speed);
		if (this.movement.LEFT) this.pos.subtract(speed, 0);
